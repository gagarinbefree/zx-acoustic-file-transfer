...
- Use Bootstrap 5.3.8 as the project UI foundation. Keep the interface clean, responsive, semantic, keyboard-accessible, and focused on transfer actions and diagnostics. Do not restore the ZX Spectrum visual theme, static 4:3 frame, decorative loading stripes, Tailwind, or another UI library without an explicit product decision.
